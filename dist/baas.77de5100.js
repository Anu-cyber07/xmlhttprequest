...
var IDB = function init() {
  ...
  DBOpenReq.addEventListener('success', function (ev) {
    //DB has been opened... after upgradeneeded
    db = ev.target.result;
    console.log('success', db);
  });
  DBOpenReq.addEventListener('upgradeneeded', function (ev) {
  ...
  document.addEventListener('submit', function (ev) {
    ev.preventDefault(); //one of the form buttons was clicked
    ...
    var store = tx.objectStore('clientStore');
    var request = store.add(client);
...
//# sourceMappingURL=/baas.77de5100.js.map